...
This will output all the license to the `build/licenses` directory. The output will look similar to the Savant repository structure. For example, the license text for the Commons Collection project will be output to the directory:
