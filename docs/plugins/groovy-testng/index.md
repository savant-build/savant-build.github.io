...
The Groovy TestNG plugin allows you to execute TestNG tests in a Groovy project. The features of the plugin are also the public methods of the plugin class, so you can refer to the [Groovy Doc](docs/) for more information.
...
These two properties specify the versions to use, but you must also configure the location of these GDK and JDK on your computer. These locations are configured in two configuration files in your home directory. These files are:
...
The first file is used to define the location of the JDKs on your computer. Here's an example of the `~/.config/savant/plugins/org.savantbuild.plugin.java.properties` file:
...
Here's an example of the `~/.config/savant/plugins/org.savantbuild.plugin.groovy.properties` file:

~~~~ 
2.4=/Users/me/dev/groovy/groovy-2.4.21
2.5=/Users/me/dev/groovy/groovy-2.5.23
3.0=/Users/me/dev/groovy/groovy-3.0.21
...
The `indy` flag toggles whether to invoke dynamic support is enabled when TestNG executes your tests. This is set to `false` by default. This flag can be set like this:
