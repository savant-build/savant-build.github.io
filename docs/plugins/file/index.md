...
This adds all the files in the `src/main/java` directory to the tarball `build/tars/foobar.tar.gz`. This also compresses the tarball.
...
This adds all the files in the `src/main/java` directory to the ZIP  `build/tars/foobar.zip`.
