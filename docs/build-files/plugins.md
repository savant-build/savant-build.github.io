...
Finally, you need to create a special configuration file for the Java plugin that tells Savant the location of the JDK. Create the file `~/.config/savant/plugins/org.savantbuild.plugin.java.properties` and put the full path to the JDK base directory in it like this:

~~~~ 
17=/some-path-to-java/jdk17
~~~~ 
